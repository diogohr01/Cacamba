...
import { Layout, Button, Row, Col, Card, Modal, Typography, Divider } from 'antd';
        ...
        <Layout>
            <Content>
                <Row gutter={[16, 16]}>
                    ...
                    <Col span={8}>
                        <Card title="Modais Confirmação" bordered={false}>
                            <Typography.Text>
                    ...
                    <Col span={8}>
                        <Card title="Modais Info" bordered={false}>
                            <Typography.Text>
                    ...
                    <Col span={8}>
                        <Card title="Modais Form" bordered={false}>
                            <Typography.Text>
