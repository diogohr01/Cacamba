...
import { Button, Card, Checkbox, Col, Divider, Form, Input, InputNumber, Modal, Row, Select, Tabs, Typography } from 'antd';
...
const DragAndDropFormBuilder = () => {
    ...
    return (
        <div>
            <DragDropContext onDragEnd={onDragEnd}>
                ...
                <div style={{ display: 'flex', gap: '16px' }}>
                    <Droppable droppableId="toolbox" isDropDisabled={true}>
                        {(provided) => (
                            <Card title="Campos Disponíveis" bordered={false} ref={provided.innerRef} {...provided.droppableProps}>
                    ...
                    <Card title="Formulário" style={{ flex: 1 }} bordered={false} extra={<Button type="primary" onClick={addSection} style={{ margin: '16px' }}>Adicionar Seção</Button>}>
            ...
            <Card style={{ marginTop: 10 }} title="JSON de Configuração do Formulário (lembre de trocar os id's (GUID) para as colunas do banco):" bordered={false}>
                <pre>{JSON.stringify(sections, null, 2)}</pre>
            </Card>

            <Card style={{ marginTop: 10 }} title="Form Final" bordered={false}>
                <DynamicForm
                    formConfig={sections}
                    values={form}
                    setValues={setForm}
                ...
                <Typography.Text>Objeto:</Typography.Text>
