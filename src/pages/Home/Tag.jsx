  ...
  const [formConfig] = useState([
    {
      ...
      columns: 1,
      questions: [
        { type: "text", id: "Nome", required: true, placeholder: "Nome do Tag", label: "Nome do Tag" },
      ],
    },
  ]);
        ...
        <Row gutter={[8, 8]}>
          <Col span={24}>
            ...
            style={{
              ...
              title={<span style={{ color: colors.cinzaIcone, borderBottom: 0}}>Tags</span>} // Garante que o título siga a cor
              bordered={false}
              extra={
                view === 'list' ? (
