  ...
  const [formConfig] = useState([
    {
      ...
      columns: 1,
      questions: [
        { type: "text", id: "Nome", required: true, placeholder: "Nome da Empresa", label: "Nome da Empresa" },
      ],
    },
  ]);
        ...
        <Row gutter={[8, 8]}>
          <Col span={24}>
            ...
            style={{
              ...
              title={<span style={{ color: colors.cinzaIcone, borderBottom: 0}}>Empresa</span>} // Garante que o título siga a cor
              bordered={false}
              extra={
                view === 'list' ? (
